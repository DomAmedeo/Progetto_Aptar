...
Per sviluppare questa applicazione Angular ho utilizzato un approccio basato sulla divisione in cartelle.
Sulla parte del backend ho utilizzato:
- express per la gestione delle richieste http 
- cors per consentire ad angular di accedere alle risorse sul server (express)
